...
import TestPicture from './SWC.png'
import JAVA from './java.jpg'
import PYTHON from './python.jpg'
import CPLUSPLUS from './cplusplus.jpg'
function Skills() {
    return (
        <div>
            ...
            <div className="container is-fluid" id="content">
                <section data-section-id={1} data-component-id="29e6_7_02_awz" data-category="team" className="section">
                    <div className="container has-text-centered">
                        <h2 className="title" data-config-id="header">Programming Languages</h2>
                        ...
                        <div className="columns is-centered is-multiline" data-config-id="team_02">
                            ...
                            <div className="column is-3">
                                <div className="level">
                                    <div className="level-item">
                                        <figure className="image is-128x128"><img className="is-rounded" src={TestPicture} alt="" /></figure>
                                    </div>
                                </div>
